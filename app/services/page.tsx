...
// Shown if DB is empty or unreachable
const STATIC_SERVICES: Service[] = [
  {
    id: "1", icon: "🌴", status: "active",
    title: "Oil Palm Farming",
    image_url: "/image/gallery11.jpg",
    short: "Sustainable plantation management and premium oil palm cultivation.",
    details: "Our oil palm farming division operates large-scale plantations using advanced agronomic techniques and environmentally responsible practices. From seed selection and nursery development to harvesting and logistics, we implement precision agriculture methods that maximize yield while preserving soil health and biodiversity.",
    process: ["Land preparation and soil analysis","High-quality seedling cultivation","Smart irrigation and nutrient management","Integrated pest and disease control","Sustainable harvesting and supply chain coordination"],
    benefits: ["High-yield plantation systems","Environmentally responsible cultivation","Traceable farm-to-mill operations","Consistent raw material supply"],
  },
  {
    id: "2", icon: "⚗️", status: "active",
    title: "Palm Oil Production",
    image_url: "/image/gallery2.jpg",
    short: "Modern extraction and processing for premium-grade palm oil.",
    details: "Our palm oil production facilities are equipped with modern extraction and processing technology designed to deliver efficiency, purity, and quality consistency. We apply strict quality assurance protocols at every stage — from sterilization and threshing to pressing and clarification.",
    process: ["Fresh fruit bunch sterilization","Mechanical threshing and digestion","High-efficiency oil pressing","Clarification and filtration","Quality testing and packaging"],
    benefits: ["Premium food-grade oil quality","Industrial-scale production capacity","Compliance with global standards","Reliable bulk supply for manufacturers"],
  },
  {
    id: "3", icon: "🔬", status: "active",
    title: "Palm Kernel Oil Refining",
    image_url: "/image/gallery8.jpg",
    short: "Refined palm kernel oil for food, cosmetic, and industrial sectors.",
    details: "Our palm kernel oil refining process ensures high-purity output suitable for diverse applications including food processing, cosmetics, pharmaceuticals, and biofuel production. Through controlled filtration, deodorization, and fractionation processes, we remove impurities while preserving functional properties.",
    process: ["Kernel crushing and oil extraction","Controlled filtration and purification","Deodorization and refining","Fractionation for industry-specific applications","Laboratory quality certification"],
    benefits: ["Multi-industry applicability","High-purity refined output","Strict safety compliance","Export-ready quality standards"],
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white font-sans text-gray-800">
      ...
      >
        ...
        <div className="relative text-center px-5 sm:px-8 max-w-3xl mx-auto">
          ...
          >Our Professional Services</motion.h1>
          <motion.p
            initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.4 }}
            className="text-white text-sm sm:text-base lg:text-xl opacity-90 max-w-2xl mx-auto leading-relaxed"
          >Delivering excellence across the entire palm oil value chain — from sustainable farming to refined production.</motion.p>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-10 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="mb-5 sm:mb-6">
            <span className="inline-block bg-green-100 text-green-800 text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-3 sm:mb-4">About Us</span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-green-800">About EMGO Farms</h2>
          </motion.div>
          <div className="space-y-3 sm:space-y-4">
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1 }} className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
              Founded in August 2020, EMGO Farms started with a small 4-acre farm in Ogun State and has expanded to 5 hectares in Uyo, Akwa Ibom, aiming to plant 50,000 oil palms by 2030. We are committed to sustainable farming, eco-friendly production, and community empowerment.
            </motion.p>
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
      ...
      <section className="pb-14 sm:pb-18 lg:pb-20">
        <div className="max-w-5xl mx-auto px-5 sm:px-8 lg:px-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center mb-8 sm:mb-10">
            <span className="inline-block bg-orange-100 text-orange-700 text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-3">Our Services</span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-green-800">What We Do Best</h2>
          ...
          {loading && (
            <div className="space-y-5">
              {[1, 2, 3].map(i => (
                <div key={i} className="bg-white rounded-3xl shadow h-40 animate-pulse border border-gray-100" />
              ))}
            </div>
          )}
                ...
                >
                  ...
                  >
                    <div className="flex flex-col sm:flex-row">
                      ...
                      {/* Image */}
                      <div className="relative w-full sm:w-1/3 h-48 sm:h-auto sm:min-h-[200px] lg:min-h-[240px] flex-shrink-0 bg-green-100">
                        {service.image_url ? (
                          <Image
                      ...
                      <div className="flex-1 p-5 sm:p-7 lg:p-8 flex items-center justify-between gap-4">
                        <div className="flex items-start gap-4 sm:gap-5">
                          <div className={`hidden sm:flex w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br ${ACCENT_CLASSES[idx % ACCENT_CLASSES.length]} items-center justify-center text-2xl shadow-md flex-shrink-0`}>
                            {service.icon || "🌿"}
                          </div>
                          <div>
                            <div className="flex items-center gap-2 mb-1 sm:mb-2">
                              <span className="text-lg sm:hidden">{service.icon || "🌿"}</span>
                              <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold text-green-800 leading-tight">{service.title}</h3>
                            </div>
                            <p className="text-gray-500 text-sm sm:text-base leading-relaxed">{service.short}</p>
                          </div>
                        </div>
                    ...
                    {active === service.id && (
                      ...
                      >
                        <div className="px-5 sm:px-7 lg:px-10 pb-7 sm:pb-8 lg:pb-10 border-t border-gray-100">
                          {service.details && (
                            <p className="mt-5 sm:mt-6 text-gray-600 leading-relaxed text-sm sm:text-base">{service.details}</p>
                          )}
                          ...
                          <div className="mt-7 sm:mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                                ...
                                <ul className="space-y-2.5">
                                  {service.process.filter(Boolean).map((step, i) => (
                                    <li key={i} className="flex items-start gap-2.5 text-gray-600 text-sm sm:text-base">
                                      <span className="w-5 h-5 rounded-full bg-green-200 text-green-800 font-bold text-xs flex items-center justify-center flex-shrink-0 mt-0.5">{i + 1}</span>
                                      {step}
                                    </li>
                                  ))}
                                </ul>
                            ...
                            {Array.isArray(service.benefits) && service.benefits.filter(Boolean).length > 0 && (
                              <div className="bg-orange-50 rounded-2xl p-5 sm:p-6">
                                ...
                                <ul className="space-y-2.5">
                                  {service.benefits.filter(Boolean).map((benefit, i) => (
                                    <li key={i} className="flex items-start gap-2.5 text-gray-600 text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-green-100">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 lg:px-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-center mb-10 sm:mb-12">
            <span className="inline-block bg-green-200 text-green-800 text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-3 sm:mb-4">Our Strengths</span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-green-800 mb-3 sm:mb-4">Why Choose EMGO Farms?</h2>
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed max-w-3xl mx-auto">
              EMGO Farms combines sustainable agriculture, modern processing technology, strict quality control, and a strong logistics network to ensure premium products and dependable service.
            </p>
          </motion.div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {trustPoints.map((point, idx) => (
              <motion.div key={idx} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: idx * 0.1 }}
      ...
      <section className="py-14 sm:py-16 lg:py-20 bg-green-900 text-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 lg:px-10 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            <span className="inline-block bg-white/10 border border-white/20 text-green-200 text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-4 sm:mb-5">Partner With Us</span>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-5 leading-tight">Let's Build a Sustainable Future Together</h2>
